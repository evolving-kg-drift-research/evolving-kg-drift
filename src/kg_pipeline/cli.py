...
from .snapshot_runner import run_snapshots
...
def _parser() -> argparse.ArgumentParser:
    ...
    snapshot = commands.add_parser("snapshot", help="Build canonical bitemporal snapshots from FactVersions")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "init-run":
            ...
            payload = run_snapshots(repo_root, args.run)
            exit_code = 0
